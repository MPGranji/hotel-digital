  ...
  return (
    <div className="min-h-dvh">
      ...
      <div className={`min-w-0 transition-[padding] duration-200 ${collapsed ? "lg:pl-20" : "lg:pl-64"}`} inert={mobileOpen}>
        ...
        <main className={`mx-auto min-w-0 ${pathname === "/dashboard" ? "max-w-none px-2 pb-2 pt-2 sm:px-3 lg:h-[calc(100dvh-4rem)] lg:overflow-hidden lg:px-4" : "max-w-[1560px] px-4 pb-12 pt-7 sm:px-6 lg:px-8"} ${pathname === "/room-status" ? "xl:h-[calc(100dvh-4rem)] xl:overflow-hidden xl:py-4" : ""}`} id="main-content" tabIndex={-1}>
          {children}
        </main>
      </div>
    </div>
